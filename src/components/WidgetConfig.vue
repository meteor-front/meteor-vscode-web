            ...
            <el-radio-group v-model="data.options.defaultValue">
              ...
              >
                <li v-for="(item, index) in data.options.options" :key="index">
                  ...
                  >
                    <el-input v-model="item.value" :style="{'width': data.options.showLabel? '90px': '190px' }" size="mini" />
                    <el-input v-if="data.options.showLabel" v-model="item.label" style="width:100px;" size="mini" />
                    <!-- <input v-model="item.value"/> -->
                  </el-radio>
                  <i class="drag-item" style="font-size: 16px;margin: 0 5px;cursor: move;"><icon name="bars" /></i>
